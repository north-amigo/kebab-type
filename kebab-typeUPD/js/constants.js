...
export const russianEnglishTexts20 = [
...
export const russianEnglishTexts40 = [
...
export const russianEnglishTexts60 = [
...
export const russianRadio = document.querySelector("#russian");
export const englishRadio = document.querySelector("#english");
export const russianEnglishRadio = document.querySelector("#russian-english");

export const words20Radio = document.querySelector("#words-20");
export const words40Radio = document.querySelector("#words-40");
export const words60Radio = document.querySelector("#words-60");

export const simulator = document.querySelector(".simulator");
export const text = document.querySelector(".text");
export const generateButton = document.querySelector(".generate-btn");
export const restartButton = document.querySelector(".restart-btn");
export const focusError = document.querySelector(".focus-error");
export const mistakesCounterSpan = document.querySelector(".mistakes-counter");
export const mistakesCounterDiv = document.querySelector(".mistakes");
export const amountWords = document.querySelector(".amount-words");
